# Graduation Project – SLaM Dunk: 경량 언어 모델 학습 플랫폼
...
![시스템 구성도](frontend\public\img\system.png)
...
![시스템 흐름도](./img/flow.png)  
*(예: 학습 요청 → 모델 구조 검증 → 학습 실행 → 상태 모니터링 → 결과 저장/추론)*
...
- 프로젝트 발표 PPT: `/docs/presentation.pdf`  
- 시연 영상: [링크 또는 캡처 삽입]  
...
4. MLflow. (2024). *MLflow: Open source platform for the machine learning lifecycle*. [Online]. Available: [https://mlflow.org](https://mlflow.org)  
5. S. Raschka, *Build a Large Language Model From Scratch — Official Code Repository*, GitHub, 2024. [Online]. Available: [https://github.com/rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)  
